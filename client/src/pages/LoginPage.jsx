...
const LoginPage = () => {
  ...
  return (
    <div className='min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex'>
           {/* ------------------ left ------------------- */}
           ...
           <img src={assets.logo_big} alt="" className='w-[min(30vw,250px)]' />   
            ...
            flex-col gap-6 rounded-lg shadow-lg'>
                      ...
                      {currState === "Sign up"  &&   !isDataSubmitted && (
                                <input  onChange={(e)=>setFullName(e.target.value)} value={fullName}  type="text"  className='p-2 bg-transparent border border-gray-500 rounded-md focus:outline-none'  
                      ...
                      {!isDataSubmitted && (
                             <>
                               <input onChange={(e)=>setEmail(e.target.value)} value={email}   
                                type="email"  placeholder='Email Address'  required className='p-2 bg-transparent
                               border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500' /> 

                                <input onChange={(e)=>setPassword(e.target.value)} value={password}   
                                type="password"  placeholder='Password'  required className='p-2 bg-transparent
                               border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500' /> 
                             </>
                      )}
...

                      {
                          currState === "Sign up" && isDataSubmitted && (
                                   ...
                                   rows={4} className='p-2 bg-transparent border border-gray-500 rounded-md
